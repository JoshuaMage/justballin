<div class="flex justify-center bg-base-200">
 <footer class="footer sm:footer-horizontal  text-base-content p-10 w-full max-w-7xl">
	<nav>
	...
	<form>
		...
		<fieldset class="w-full">
			...
			<div class="join">
				...
				<button class="btn btn-sm btn-primary join-item">Subscribe</button>
			</div>
			<div class="flex max-md:flex-col w-full gap-1 mt-2">
				<button class="btn btn-sm border-black bg-black text-white">
					<svg
				...
				<!-- Google -->
				<button class="btn btn-sm border-[#e5e5e5] bg-white text-black">
					<svg
				...
				<button class="btn btn-sm border-[#005fd8] bg-[#1A77F2] text-white">
					<svg
			...
			<button class="btn btn-sm border-[#0059b3] bg-[#0967C2] text-white">
				<svg
